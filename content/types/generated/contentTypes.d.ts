...
export interface ApiArticlePageArticlePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    charts: Attribute.Relation<
      'api::article-page.article-page',
      'oneToMany',
      'api::chart.chart'
    >;
    chart: Attribute.DynamicZone<['chart.bar-chart', 'chart.single-stat']>;
...
export interface ApiComponentComponent extends Schema.CollectionType {
  ...
  attributes: {
    ComponentType: Attribute.Enumeration<
      ['BarChart', 'HorizontalBarChart', 'Map', 'ScatterChart']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiPagePage extends Schema.SingleType {
  ...
  attributes: {
    title: Attribute.String;
    Charts: Attribute.DynamicZone<['chart.bar-chart', 'chart.single-stat']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
